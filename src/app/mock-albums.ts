...
export const ALBUMS: Album[] = [
  ...
  new Album("Led Zeppelin IV", "Led Zeppelin",
    "The album contains one of the band's best known songs, Stairway to Heaven", 7),
  new Album("Blood on the Tracks", "Bob Dylan", "the 15th studio album by American singer-songwriter Bob Dylan, released on January 20, 1975", 8)
];
